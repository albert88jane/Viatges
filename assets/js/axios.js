...
window.onload = function() {
    ...
    .then(function(info) {
        ...
        for(let i=0; i < numJson.length; i++){
            ...
            contenedor += "<h5 class='card-title titol '> " + info.data[i].titol + "</h5>";
            contenedor += "<p class='card-text descripcio'> " + info.data[i].descripcio + "</p>";
            ...
            contenedor += "</svg>" + info.data[i].vots_positius ;
            contenedor += "</button>";
            contenedor += "</p>";
            ...
            contenedor += "</svg>" + info.data[i].vots_negatius ;
            contenedor += "</button>"; 
            contenedor += "</p>";
            contenedor += "</div>";
            contenedor += "</div>";
...
//FILTRO CATEGORIA
  ...
  document.getElementById('sel_cat').addEventListener('click',function(){
        
   
    var valor = document.getElementById('sel_cat').value;
